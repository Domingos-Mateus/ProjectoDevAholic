...
Route::get('/listar_encarregados_gs', 'App\Http\Controllers\sheetDbController@get_encarregados');
Route::get('/salvar_encarregado_gs', 'App\Http\Controllers\sheetDbController@salvar_encarregado_gs');
